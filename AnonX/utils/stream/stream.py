...
from AnonX.utils.database import add_active_video_chat, is_active_chat, is_video_allowed
    ...
    if streamtype == "playlist":
        ...
        for search in result:
            ...
            if await is_active_chat(chat_id):
                ...
                await Anon.join_call(chat_id, original_chat_id, file_path, video=status)
                await put_queue(
                    chat_id,
                    original_chat_id,
        ...
        if await is_active_chat(chat_id):
            ...
            if not forceplay:
                db[chat_id] = []
            await Anon.join_call(chat_id, original_chat_id, file_path, video=None)
            await put_queue(
                chat_id,
                original_chat_id,
                file_path,
